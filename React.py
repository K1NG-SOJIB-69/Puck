...
def baliho():
	...
	try:
		...
		print ('F S T').center(44)

		print (W + '     [' + G +'Facebook Super Tool'+ W + ']')
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     My Hacks Wiki

    Name       Facebook Super Tool

    Version    1.0

    Date       25/09/2018 

    Facebook   Facebook.com/myhackswiki

    Twitter    twitter.com/samit_hota

    Instagram  instagram.com/samit.hota 

    site       myhackswiki.blogspot.com
...
def menu_reaction_ask():
  ...
  try:
	...
	cek = raw_input(R + 'fst' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
