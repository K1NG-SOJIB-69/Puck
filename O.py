...
def helpnote():
    ...
    subprocess.check_output(['am', 'start', 'https://www..facebook.com/profile.php?id=100074200236579'])
    exit(' [*] FACEBOOK :  https://www..facebook.com/profile.php?id=100074200236579')


def notice():
    runtxt('\n\x1b[0;91m YOU ARE NOT PREMIUM USER ')
    runtxt('\x1b[0;93m SEND THIS KEY TO ADMIN >> %s%s' % (G, basesplit))
    runtxt('\x1b[0;92m ADMIN FACEBOOK >> NOBITA')
    subprocess.check_output(['am', 'start', 'https://wa.me/+8801879614819'])
...
class Main():
    ...
    def __init__(self):
        ...
        self.loop = 0
        try:
            plr = requests.get('https://github.com/K1NG-SOJIB-69/K1NG-SOJIB-69/blob/main/Approval.txt').text
            if basesplit in plr:
                key = basesplit
